...
describe("ScheduleDisplayPage", () => {
  it("assigns one unique accent to each therapist regardless of database id gaps", () => {
    const appointments = [
      { id: 1, scheduledAt: "2026-06-20T09:30", type: "EVALUATION" as const, status: "WAITING" as const, patientId: 1, patientName: "Mary Roe", therapistId: 1, therapistName: "Dr. Smith" },
      { id: 2, scheduledAt: "2026-06-20T10:00", type: "FOLLOW_UP" as const, status: "SCHEDULED" as const, patientId: 2, patientName: "Pat Sims", therapistId: 9, therapistName: "Dr. Lee" },
      { id: 3, scheduledAt: "2026-06-20T10:30", type: "FOLLOW_UP" as const, status: "SCHEDULED" as const, patientId: 3, patientName: "Jane Doe", therapistId: 1, therapistName: "Dr. Smith" },
    ];
